  ...
  useEffect(() => {
    if (settings) {
      setFormData({
        ...
        customization: settings.customization || formData.customization
      });
    }
  }, [settings]);
              ...
              {formData.notifications.enabled && (
                <div style={{
                  ...
                  <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                    <input
                      type="checkbox"
                      checked={formData.notifications.platforms.slack}
                      onChange={() => handlePlatformToggle('slack')}
                      style={{ width: '16px', height: '16px', marginRight: '8px', cursor: 'pointer' }}
                    />
                    <span style={{ fontSize: '14px', color: '#333' }}>Slack</span>
                  </label>

                  <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                    <input
                      type="checkbox"
                      checked={formData.notifications.platforms.discord}
                      onChange={() => handlePlatformToggle('discord')}
                      style={{ width: '16px', height: '16px', marginRight: '8px', cursor: 'pointer' }}
                    />
                    <span style={{ fontSize: '14px', color: '#333' }}>Discord</span>
                  </label>

                  <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                    <input
                      type="checkbox"
                      checked={formData.notifications.platforms.telegram}
                      onChange={() => handlePlatformToggle('telegram')}
                      style={{ width: '16px', height: '16px', marginRight: '8px', cursor: 'pointer' }}
                    />
                    <span style={{ fontSize: '14px', color: '#333' }}>Telegram</span>
                  </label>

                  <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                    <input
                      type="checkbox"
                      checked={formData.notifications.platforms.email}
